                        ...
                        <div class="recent-item">
                            <figure>
                                <div class="bwWrapper touching medium">
                                    ...
                                    <a href="img/portfolio/work_1.png" class="hover-zoom mfp-image" ><i class="fa fa-search"></i></a>
                                    <a class="hover-link">
                        ...
                        <div class="recent-item">
                            <figure>
                                <div class="bwWrapper touching medium">
                                    ...
                                    <a href="img/portfolio/work_2.png" class="hover-zoom mfp-image" ><i class="fa fa-search"></i></a>
                                    <a class="hover-link"><i class="fa fa-link"></i></a>
                                </div>
                                <figcaption class="item-description">
                                    <h5>Inverters</h5>
                        ...
                        <div class="recent-item">
                            <figure>
                                <div class="bwWrapper touching medium">
                                    ...
                                    <a href="img/portfolio/work_3.png" class="hover-zoom mfp-image" ><i class="fa fa-search"></i></a>
                                    <a class="hover-link"><i class="fa fa-link"></i></a>
                                </div>
                                <figcaption class="item-description">
                        ...
                        <div class="recent-item">
                            <figure>
                                <div class="bwWrapper touching medium">
                                    ...
                                    <a href="img/portfolio/work_4.png" class="hover-zoom mfp-image" ><i class="fa fa-search"></i></a>
                                    <a class="hover-link"><i class="fa fa-link"></i></a>
                                </div>
                                <figcaption class="item-description">
                                    <h5>Solar Power</h5>
                        ...
                        <div class="recent-item">
                            <figure>
                                <div class="bwWrapper touching medium">
                                    ...
                                    <a href="img/portfolio/work_5.png" class="hover-zoom mfp-image" ><i class="fa fa-search"></i></a>
                                    <a class="hover-link"><i class="fa fa-link"></i></a>
                                </div>
                                <figcaption class="item-description">
                                    <h5>Power Banks</h5>
                        ...
                        <div class="tab_container"> 
                            <div id="tab1" class="tab_content"> 
                                ...
                                <ul class="list_style circle">
                                    <li><a ><i class="fa fa-angle-right"></i> Competent Engineers and Technicians.</a></li>
                                    <li><a ><i class="fa fa-angle-right"></i> Top-notch testing equipment.</a></li>
                                    <li><a ><i class="fa fa-angle-right"></i> Strict measures towards achieving <b>zero fault occurences.</b></a></li>
                                </ul>
